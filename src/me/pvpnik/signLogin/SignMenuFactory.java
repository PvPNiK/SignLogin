...
public class SignMenuFactory {
        ...
        ProtocolLibrary.getProtocolManager()
                .addPacketListener(new PacketAdapter(this.plugin, PacketType.Play.Client.UPDATE_SIGN) {
                    ...
                    public void onPacketReceiving(PacketEvent event) {
                        ...
                        player.sendBlockChange(blockPosition.toLocation(player.getWorld()),
    ...
    public static final class Menu {
        ...
        public void open() {
            ...
            player.sendBlockChange(blockPosition.toLocation(location.getWorld()), signMaterial.createBlockData());
            ...
            IntStream.range(0, SIGN_LINES).forEach(line -> signNBT.put("Text" + (line + 1),
                    text.size() > line ? String.format(NBT_FORMAT, color(text.get(line))) : "WW"));
